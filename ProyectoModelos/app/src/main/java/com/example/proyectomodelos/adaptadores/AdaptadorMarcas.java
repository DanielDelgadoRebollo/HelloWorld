...
public class AdaptadorMarcas extends BaseAdapter {
    ...
    public AdaptadorMarcas(List<Marca> listMarcas,Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageView = convertView.findViewById(R.id.imagen_coche_marca);

        textoMarca.setText(marcaActual.getMarca());
        imageView.setImageResource(marcaActual.getImagen());
        return convertView;
    }
}
